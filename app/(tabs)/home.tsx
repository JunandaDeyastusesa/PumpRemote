...
import { Pressable, Box, Card, Text, Icon, Center, HStack, VStack } from "@gluestack-ui/themed";
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <HStack mt="$4" px="$4" space="md">
          ...
          <VStack flex={1} space="sm">
            <TouchableOpacity onPress={() => router.push("/(sub-menu)/history-cuaca")} activeOpacity={0.7}>
